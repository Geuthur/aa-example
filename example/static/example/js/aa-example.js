...
/**
 * Default settings for aa-example
 ...
 * @param {string} [namespace=aa-example] Namespace for the tooltip
 ...
 * @param {string} [exportFileName='aa-example.csv'] - The name of the exported CSV file.
 * @throws Will throw an error if the table is not a valid DataTables instance.
 * @returns {void}
 */
const _exportToCSV = (DataTable, exportFileName = 'aa-example.csv') => {
