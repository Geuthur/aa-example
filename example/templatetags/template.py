...
@register.simple_tag
def example_static(relative_file_path: str, script_type: str = None) -> str | None:
    """
    Versioned static URL

    :param relative_file_path: The file path relative to the `aa-example/example/static/example` folder
    ...
    static_file_path = os.path.join("example", relative_file_path)
